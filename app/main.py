...
# Первый набор данных - для показательной реализации библиотеки Matplotlib.
data1 = np.array([[1, 2, 3, 4, 5], [1, 1, 1, 0, 1], [1, 3, 5, 7, 9]])
# Второй набор данных - различные данные для реализации множества разных графиков библиотеки Matplotlib.
